...
<script>
  ...
  export default {
    ...
    mounted(){
      const ulScroll=this.$refs.headerScroll
      const Firstmain=this.$refs.Firstmain
      const foodDetails=this.$refs.foodDetails
      const donationTitle=this.$refs.donationTitle
      let ulScroller=new BScroll(ulScroll,{
        click:true,
        scrollX: true,
      })
     this.$nextTick(()=>{
       ...
       let Firstmainer=new BScroll(Firstmain,{
         click:true,
         scrollY: true,
       })
       let foodDetailser =new BScroll(foodDetails,{
         click:true,
         scrollX: true,
       })
       let donationTitler=new BScroll(donationTitle,{
         click:true,
         scrollX: true,
       })
     })
      ...
      const headerNavbarChilds=headerNavbar.children
      ;[].slice.call(headerNavbarChilds).forEach(function(item){
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .mainWraper
    ...
    #Firstmain
      ...
      .page_line_wraper_two
          width 100%
          margin-top 12px
          .page_line_two
            background #f3f4f5
            height 10px
      .page_line_wraper_three
        width 100%
        margin-top 45px
        .page_line_three
          background #f3f4f5
      ...
      .products_show
        ...
        .erha
          ...
          img
            width 100%
        .product_discribe_wrap
          height 58px
          width 100%
          .product_discribe
            padding 10px
            .product_discribe_one
              font-size 12px
              color #999
              text-align center
              margin-bottom 5px
            .product_discribe_two
              font-size 12px
              color #999
              text-align center
              margin-bottom 5px
      ...
      .donation_list
        ...
        .donation_detail
          ...
          .donation_title
            ...
            img
             height 60px
          .donation_detail_wrap
            margin-right -72px
            float left
            width 299px
            overflow hidden
          .donation_detail_total
            overflow hidden
            width 1050px
            .donation_detail_item
              float left
              padding 2px
              height 76px
              font-size 12px
        ...
        .evaluate_wrap
          ...
          .evaluate_wrap_small
            ...
            .evaluate_wrap_item
              ...
              .evaluate_discribe
                overflow hidden
                .evaluate_discribe_one
                  float left
                  font-size 12px
                  color #333
                .evaluate_discribe_two
                  float right
                  font-size 12px
                  color #333
              .evaluate_long
